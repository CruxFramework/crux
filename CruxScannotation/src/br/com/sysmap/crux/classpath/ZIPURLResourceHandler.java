...
import br.com.sysmap.crux.scannotation.archiveiterator.DirectoryIteratorFactory;
import br.com.sysmap.crux.scannotation.archiveiterator.ZIPProtocolIteratorFactory;
...
public class ZIPURLResourceHandler extends AbstractURLResourceHandler implements PackageFileURLResourceHandler
{
	...
	/**
	 * @see br.com.sysmap.crux.classpath.PackageFileURLResourceHandler#getPackageFile(java.net.URL)
	 */
	...
	/**
	 * @see br.com.sysmap.crux.classpath.PackageFileURLResourceHandler#getPackaegResourceName(java.net.URL)
	 */
