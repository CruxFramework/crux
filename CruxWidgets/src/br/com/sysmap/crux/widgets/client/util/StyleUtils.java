...
/**
 * Contains common operations for handling styles of HTML elements
 * 
...
public class StyleUtils
{
	...
	private static void setStyleName(Element elem, String style, boolean add)
	{
		if (elem == null)
		{
			throw new RuntimeException("Null element!"); // TODO msg
		}

		style = style.trim();
		if (style.length() == 0)
		{
			throw new IllegalArgumentException("Empty style name!"); // TODO msg
		}
