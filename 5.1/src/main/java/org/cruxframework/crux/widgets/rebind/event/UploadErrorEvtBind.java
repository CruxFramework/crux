 ...
 *
 */
public class UploadErrorEvtBind extends EvtProcessor
{
	public UploadErrorEvtBind(WidgetCreator<?> widgetCreator)
    {
	    super(widgetCreator);
    }

	private static final String EVENT_NAME = "onUploadError";
    ...
    {
	    return UploadErrorEvent.class;
    }

	@Override
    public Class<?> getEventHandlerClass()
    {
	    return UploadErrorHandler.class;
    }
}
