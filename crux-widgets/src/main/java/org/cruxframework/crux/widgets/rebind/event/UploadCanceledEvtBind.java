 ...
 *
 */
public class UploadCanceledEvtBind extends EvtProcessor
{
	public UploadCanceledEvtBind(WidgetCreator<?> widgetCreator)
    {
	    super(widgetCreator);
    }

	private static final String EVENT_NAME = "onUploadCanceled";
    ...
    {
	    return UploadCanceledEvent.class;
    }

	@Override
    public Class<?> getEventHandlerClass()
    {
	    return UploadCanceledHandler.class;
    }
}
