 ...
 *
 */
public class AddFileEvtBind extends EvtProcessor
{
	public AddFileEvtBind(WidgetCreator<?> widgetCreator)
    {
	    super(widgetCreator);
    }

	private static final String EVENT_NAME = "onAddFile";
    ...
    {
	    return AddFileEvent.class;
    }

	@Override
    public Class<?> getEventHandlerClass()
    {
	    return AddFileHandler.class;
    }
}
