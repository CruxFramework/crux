...
public class BeforeOpenEvtBind extends EvtProcessor
{
	public BeforeOpenEvtBind(WidgetCreator<?> widgetCreator)
    {
	    super(widgetCreator);
    }
    ...
    {
	    return BeforeOpenEvent.class;
    }

	@Override
    public Class<?> getEventHandlerClass()
    {
	    return BeforeOpenHandler.class;
    }		
}
