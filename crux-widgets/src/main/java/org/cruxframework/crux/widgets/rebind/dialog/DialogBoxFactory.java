 ...
 */
@DeclarativeFactory(id="dialogBox", library="widgets", attachToDOM=false, targetWidget=DialogBox.class,
...
@TagAttributes({
	@TagAttribute(value="title", supportsI18N=true, description="Sets the Dialog title."),
})
...
public class DialogBoxFactory extends PanelFactory<WidgetCreatorContext>
       implements HasCloseHandlersFactory<WidgetCreatorContext>
{
	@Override
	public void instantiateWidget(SourcePrinter out, WidgetCreatorContext context) throws CruxGeneratorException
	{
		...
		out.println("final "+className + " " + context.getWidget()+" = new "+className+"("+movable+", "+resizable+", "+closable+");");
	}
