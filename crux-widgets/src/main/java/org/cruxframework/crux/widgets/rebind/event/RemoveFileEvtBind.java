 ...
 *
 */
public class RemoveFileEvtBind extends EvtProcessor
{
	public RemoveFileEvtBind(WidgetCreator<?> widgetCreator)
    {
	    super(widgetCreator);
    }

	private static final String EVENT_NAME = "onRemoveFile";
    ...
    {
	    return RemoveFileEvent.class;
    }

	@Override
    public Class<?> getEventHandlerClass()
    {
	    return RemoveFileHandler.class;
    }
}
