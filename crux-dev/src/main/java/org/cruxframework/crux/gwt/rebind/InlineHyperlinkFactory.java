 ...
 *
 */
@DeclarativeFactory(id="inlineHyperlink", library="gwt", targetWidget=InlineHyperlink.class)
@TagAttributes({
	@TagAttribute("targetHistoryToken")
})
@TagChildren({
	@TagChild(value=InlineHyperlinkFactory.ContentProcessor.class, autoProcess=false)
})
