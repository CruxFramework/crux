 ...
 */
public class ViewUnloadEvtBind extends EvtProcessor
{
	public ViewUnloadEvtBind(WidgetCreator<?> widgetCreator)
    {
	    super(widgetCreator);
    }

	private static final String EVENT_NAME = "onViewUnload";
    ...
    {
	    return ViewUnloadEvent.class;
    }

	@Override
    public Class<?> getEventHandlerClass()
    {
	    return ViewUnloadHandler.class;
    }	
    ...
    public void processEvent(SourcePrinter out, String eventValue, String parentVariable, String widgetId)
    {
		...
		out.println("public void onUnload("+getEventClass().getCanonicalName()+" event){");
