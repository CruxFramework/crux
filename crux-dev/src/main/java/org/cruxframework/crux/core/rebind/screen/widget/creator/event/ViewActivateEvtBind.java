 ...
 */
public class ViewActivateEvtBind extends EvtProcessor
{
	public ViewActivateEvtBind(WidgetCreator<?> widgetCreator)
    {
	    super(widgetCreator);
    }

	private static final String EVENT_NAME = "onViewActivate";
    ...
    {
	    return ViewActivateEvent.class;
    }

	@Override
    public Class<?> getEventHandlerClass()
    {
	    return ViewActivateHandler.class;
    }	
    ...
    public void processEvent(SourcePrinter out, String eventValue, String parentVariable, String widgetId)
    {
		...
		out.println("public void onActivate("+getEventClass().getCanonicalName()+" event){");
