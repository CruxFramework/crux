...
/**
 * Helper Class for selectEnd events binding
 * @author Thiago Bustamante
 *
 */
public class SelectEndEvtBind extends EvtProcessor
{
	public SelectEndEvtBind(WidgetCreator<?> widgetCreator)
    {
	    super(widgetCreator);
    }

	private static final String EVENT_NAME = "onSelectEnd";
    ...
    {
	    return SelectEndEvent.class;
    }

	@Override
    public Class<?> getEventHandlerClass()
    {
	    return SelectEndHandler.class;
    }
}
