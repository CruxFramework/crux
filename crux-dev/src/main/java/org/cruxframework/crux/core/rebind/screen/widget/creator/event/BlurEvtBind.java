 ...
 *
 */
public class BlurEvtBind extends EvtProcessor
{
	public BlurEvtBind(WidgetCreator<?> widgetCreator)
    {
	    super(widgetCreator);
    }

	private static final String EVENT_NAME = "onBlur";
    ...
    {
	    return BlurEvent.class;
    }

	@Override
    public Class<?> getEventHandlerClass()
    {
	    return BlurHandler.class;
    }
}
