 ...
 *
 */
public class MouseOverEvtBind extends EvtProcessor
{
	public MouseOverEvtBind(WidgetCreator<?> widgetCreator)
    {
	    super(widgetCreator);
    }
    ...
    {
	    return MouseOverEvent.class;
    }

	@Override
    public Class<?> getEventHandlerClass()
    {
	    return MouseOverHandler.class;
    }		
}
