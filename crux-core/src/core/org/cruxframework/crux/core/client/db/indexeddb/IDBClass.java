...
public class IDBClass extends JavaScriptObject
{
	...
	public final native void onError(IDBErrorEvent.Handler handler) /*-{
		this.onerror = function(evt) {
	    	handler.@org.cruxframework.crux.core.client.db.indexeddb.events.IDBErrorEvent.Handler::onError(Lorg/cruxframework/crux/core/client/db/indexeddb/events/IDBErrorEvent;)(evt);
		};              
	}-*/;
}
