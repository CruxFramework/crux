...
public class CacheControl {
    ...
    public static CacheControl valueOf(final String value) {
        return CacheControlHeaderParser.fromString(value);
    }
    ...
    public String toString() {
        return CacheControlHeaderParser.toString(this);
    }
    ...
    public int hashCode() {
        ...
        hash = 31 * hash + (this.publicFlag ? 1231 : 1237);
        return hash;
    }
