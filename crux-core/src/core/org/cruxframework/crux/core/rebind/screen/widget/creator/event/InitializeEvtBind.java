 ...
 *
 */
public class InitializeEvtBind extends EvtProcessor
{
	public InitializeEvtBind(WidgetCreator<?> widgetCreator)
    {
	    super(widgetCreator);
    }
    ...
    {
	    return InitializeEvent.class;
    }

	@Override
    public Class<?> getEventHandlerClass()
    {
	    return InitializeHandler.class;
    }		
}
