 ...
 *
 */
@Resource(value="showcaseResources", supportedDevices={Device.largeDisplayArrows, Device.largeDisplayMouse, Device.largeDisplayTouch})
public interface ShowcaseResourcesLarge extends ClientBundle
{
	...
	ImageResource layoutSectionIcon();
}
