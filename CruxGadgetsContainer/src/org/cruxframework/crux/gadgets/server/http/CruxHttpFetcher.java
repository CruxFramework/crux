...
import org.cruxframework.crux.gadgets.server.servlet.SSOMakeRequestHandler;
 ...
 */
@Singleton
public class CruxHttpFetcher implements HttpFetcher
{
	...
	private static final Logger LOG = Logger.getLogger(CruxHttpFetcher.class.getName());
	 ...
	 * @return
	 */
	private DefaultHttpClient initializeClient(int maxObjSize, int connectionTimeoutMs, int readTimeoutMs, String basicHttpFetcherProxy, boolean allowCookies)
    {
	...
	throws GadgetException {
		...
		try {
			...
			if (request instanceof SSOHttpRequest)
			{
