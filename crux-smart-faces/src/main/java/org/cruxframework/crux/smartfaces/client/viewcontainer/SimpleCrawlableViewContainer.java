 ...
 *
 */
public class SimpleCrawlableViewContainer extends SingleCrawlableViewContainer 
{
	public static final String DEFAULT_STYLE_NAME = "faces-SimpleCrawlableViewContainer";
