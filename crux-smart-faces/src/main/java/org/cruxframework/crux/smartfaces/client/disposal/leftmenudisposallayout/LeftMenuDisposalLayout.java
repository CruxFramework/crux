 ...
 */
@Templates({
	@Template(name="leftMenuDisposalLayoutLarge", device=Device.all),
	@Template(name="leftMenuDisposalLayoutSmall", device=Device.smallDisplayArrows),
	@Template(name="leftMenuDisposalLayoutSmall", device=Device.smallDisplayTouch)
})
public interface LeftMenuDisposalLayout extends DisposalLayout, DeviceAdaptive
{
