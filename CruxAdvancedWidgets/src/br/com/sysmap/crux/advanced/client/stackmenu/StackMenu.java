...
import br.com.sysmap.crux.advanced.client.filter.Filterable;
...
public class StackMenu extends Composite implements Filterable<StackMenuItem>
{
	...
	/**
	 * @see br.com.sysmap.crux.advanced.client.filter.Filterable#filter(java.lang.String)
	 */
	...
	/**
	 * @see br.com.sysmap.crux.advanced.client.filter.Filterable#onSelectItem(java.lang.Object)
	 */
