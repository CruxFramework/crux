...
import br.com.sysmap.crux.advanced.client.event.timeout.HasTimeoutHandlers;
import br.com.sysmap.crux.advanced.client.event.timeout.TimeoutEvent;
import br.com.sysmap.crux.advanced.client.event.timeout.TimeoutHandler;
import br.com.sysmap.crux.advanced.client.util.StringUtils;
...
public class Timer extends Composite implements HasTimeoutHandlers
{
	...
	/**
	 * @see br.com.sysmap.crux.advanced.client.event.timeout.HasTimeoutHandlers#addTimeoutHandler(br.com.sysmap.crux.advanced.client.event.timeout.TimeoutHandler)
	 */
