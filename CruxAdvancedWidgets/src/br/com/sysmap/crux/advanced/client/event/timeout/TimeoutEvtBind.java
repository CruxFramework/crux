 ...
 * the License.
 */
package br.com.sysmap.crux.advanced.client.event.timeout;
...
public class TimeoutEvtBind extends EvtBind
{
	...
	{
		final String time = childElement.getAttribute("_time");
		String execute = childElement.getAttribute("_execute");
		...
		if(time != null && execute != null)
		{
			...
			if(timeoutEvent != null)
			{
				...
				{
					/**
					 * @see br.com.sysmap.crux.advanced.client.event.timeout.TimeoutHandler#onTimeout(br.com.sysmap.crux.advanced.client.event.timeout.TimeoutEvent)
					 */
					...
					/**
					 * @see br.com.sysmap.crux.advanced.client.event.timeout.TimeoutHandler#getScheduledTime()
					 */
