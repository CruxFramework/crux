 ...
 *
 */
public class PageEvtBind extends EvtProcessor
{
	public PageEvtBind(WidgetCreator<?> widgetCreator)
    {
	    super(widgetCreator);
    }

	private static final String EVENT_NAME = "onPage";
