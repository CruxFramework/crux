 ...
 *
 */
public class BeforeFocusEvtBind extends EvtProcessor
{
	public BeforeFocusEvtBind(WidgetCreator<?> widgetCreator)
    {
	    super(widgetCreator);
    }
    ...
    {
	    return BeforeFocusEvent.class;
    }

	@Override
    public Class<?> getEventHandlerClass()
    {
	    return BeforeFocusHandler.class;
    }		
}
