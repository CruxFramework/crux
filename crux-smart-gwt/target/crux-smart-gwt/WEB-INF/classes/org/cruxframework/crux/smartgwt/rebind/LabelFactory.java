...
/**
 * Factory for Label SmartGWT
 * @author Flávia Yeshua
 *
 */
@DeclarativeFactory(library="smartgwt", id="label", targetWidget=Label.class)
...
public class LabelFactory extends WidgetCreator<WidgetCreatorContext>
