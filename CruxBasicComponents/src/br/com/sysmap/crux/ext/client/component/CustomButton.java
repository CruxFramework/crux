...
public class CustomButton extends FocusComponent 
{
	...
	protected void updateAttributes(com.google.gwt.xml.client.Element element)
	{
		...
		com.google.gwt.xml.client.NodeList facesCandidates = element.getElementsByTagName("span");
		for (int i=0; i<facesCandidates.getLength(); i++)
		{
			if (isValidFace((com.google.gwt.xml.client.Element)facesCandidates.item(i)))
			{
				processFaceDeclaration((com.google.gwt.xml.client.Element)facesCandidates.item(i));
			}
		}
	}
	 ...
	 * @return
	 */
	protected boolean isValidFace(com.google.gwt.xml.client.Element element)
	{
		if ("span".equalsIgnoreCase(element.getTagName()))
		{
			String type = element.getAttribute("_faceType");
	 ...
	 * @param element
	 */
	protected void processFaceDeclaration(com.google.gwt.xml.client.Element element)
	{
		String faceType = element.getAttribute("_faceType");
		Face face = getFace(element.getAttribute("_face"));
		if (face != null)
		{
			...
			{
					face.setHTML(element.getNodeValue());
			}
		}
	}
}
