 ...
 * @deprecated Use LocalEditablePagedDataSource instead
 */
@Deprecated
@Legacy
public abstract class LocalBindableEditablePagedDataSource<T> extends LocalEditablePagedDataSource<T>
{
	/**
