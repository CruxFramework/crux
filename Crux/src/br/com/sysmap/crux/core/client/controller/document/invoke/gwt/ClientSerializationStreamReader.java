 ...
 */
public final class ClientSerializationStreamReader extends AbstractSerializationStream implements SerializationStreamReader
{
	int index;
	...
	private native int readTableSize() /*-{
		return this.@br.com.sysmap.crux.core.client.controller.document.invoke.gwt.ClientSerializationStreamReader::results[this.@br.com.sysmap.crux.core.client.controller.document.invoke.gwt.ClientSerializationStreamReader::results.length-1];
	}-*/;
	...
	private native String readTableString(int idx) /*-{
		return this.@br.com.sysmap.crux.core.client.controller.document.invoke.gwt.ClientSerializationStreamReader::results[idx];
	}-*/;
