...
{	
	...
	/*
	 * Remote data sources does not load items... they fetch pages on demand.
	 */
	@Override
	protected DataSourceRecord[] loadData()
	{
		return this.data;
	}
	...
	protected abstract DataSourceRecord[] fetchData(int startRecord, int endRecord);
}
