 ...
 *
 */
public class MouseDownEvtBind implements EvtBinder<HasMouseDownHandlers>
{
	private static final String EVENT_NAME = "onMouseDown";
	 ...
	 */
	public void bindEvent(Element element, HasMouseDownHandlers widget)
	{
		final Event eventMouseDown = EvtBind.getWidgetEvent(element, EVENT_NAME);
