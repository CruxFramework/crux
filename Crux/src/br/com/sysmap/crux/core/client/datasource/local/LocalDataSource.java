 ...
 *
 */
public abstract class LocalDataSource implements DataSource<DataSourceRecord>
{
	protected Metadata metadata;
	protected DataSourceRecord[] data;
	...
	public DataSourceRecord getRecord()
	{
	...
	protected abstract DataSourceRecord[] loadData();
}
