 ...
 * @deprecated Use RemoteEditableStreamingDataSource instead
 */
@Deprecated
public abstract class RemoteBindableEditableStreamingDataSource<T> extends RemoteEditableStreamingDataSource<T>
{
	/**
