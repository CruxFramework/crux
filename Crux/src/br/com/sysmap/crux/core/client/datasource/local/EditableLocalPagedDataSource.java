 ...
 *
 */
public abstract class EditableLocalPagedDataSource extends AbstractLocalPagedDataSource<EditableDataSourceRecord> implements EditableDataSource
{
	public EditableLocalPagedDataSource(Metadata metadata)
	{
		super(metadata);
	}
}
