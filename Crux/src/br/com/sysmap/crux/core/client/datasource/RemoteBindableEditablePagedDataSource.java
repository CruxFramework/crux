 ...
 * @deprecated Use RemoteEditablePagedDataSource instead
 */
@Deprecated
public abstract class RemoteBindableEditablePagedDataSource<T> extends RemoteEditablePagedDataSource<T>
{
	/**
