 ...
 *
 */
public class UploadCompleteEvtBind extends EvtProcessor
{
	public UploadCompleteEvtBind(WidgetCreator<?> widgetCreator)
    {
	    super(widgetCreator);
    }

	private static final String EVENT_NAME = "onUploadComplete";
    ...
    {
	    return UploadCompleteEvent.class;
    }

	@Override
    public Class<?> getEventHandlerClass()
    {
	    return UploadCompleteHandler.class;
    }
}
