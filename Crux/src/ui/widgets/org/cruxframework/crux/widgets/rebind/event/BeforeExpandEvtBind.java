...
public class BeforeExpandEvtBind extends EvtProcessor
{
	public BeforeExpandEvtBind(WidgetCreator<?> widgetCreator)
    {
	    super(widgetCreator);
    }
    ...
    {
	    return BeforeExpandEvent.class;
    }

	@Override
    public Class<?> getEventHandlerClass()
    {
	    return BeforeExpandHandler.class;
    }		
}
