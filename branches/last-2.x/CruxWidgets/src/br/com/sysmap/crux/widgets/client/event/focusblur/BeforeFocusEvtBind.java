...
public class BeforeFocusEvtBind implements EvtBinder<HasBeforeFocusHandlers>
{
	...
	public void bindEvent(Element element, HasBeforeFocusHandlers widget)
	{
		final Event eventBeforeFocus = EvtBind.getWidgetEvent(element, EVENT_NAME);
		if (eventBeforeFocus != null)
		{
			widget.addBeforeFocusHandler(new BeforeFocusHandler()
			{
				...
				{
					Events.callEvent(eventBeforeFocus, event);
				}
			});
		}
	}
