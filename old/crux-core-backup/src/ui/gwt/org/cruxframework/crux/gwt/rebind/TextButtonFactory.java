...
@TagAttributes({
	@TagAttribute(value="decoration", type=Decoration.class)
})
public abstract class TextButtonFactory extends FocusWidgetFactory<WidgetCreatorContext> 
										  implements IsCollapsibleFactory<WidgetCreatorContext>, HasTextFactory<WidgetCreatorContext>, 
