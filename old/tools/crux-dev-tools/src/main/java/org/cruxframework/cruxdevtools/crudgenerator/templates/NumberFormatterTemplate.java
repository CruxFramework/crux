...
public class NumberFormatterTemplate extends Template
{
	protected final String packageName;
	protected final String formatterName;
	protected List<String> imports = new ArrayList<String>();

	public NumberFormatterTemplate(EntityMetadata entity, File outputDir, String packageName, String formatterName)
	{
	...
	{
		return "/"+NumberFormatterTemplate.class.getPackage().getName().replace('.', '/')+"/number-formatter-template.vm";
	}
